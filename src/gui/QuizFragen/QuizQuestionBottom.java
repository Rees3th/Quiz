 ...
 * </ul>
 * <p>
 * This panel uses the delegate pattern via {@link QuizQuestionDelegate} so
 * that button actions are forwarded to the parent panel or controller,
 * keeping the UI and business logic separate.
 * </p>
 * 
...
public class QuizQuestionBottom extends JPanel {
     ...
     * <ul>
     *   <li>A {@link ButtonPanel} containing the "Delete", "Save", and "New Question" buttons</li>
     *   <li>A {@link MessagePanel} above the buttons for displaying status messages</li>
     * </ul>
     * <p>
     * When a button is clicked, the corresponding method on the current delegate (if set)
     * is invoked:
     * <ul>
    ...
    /**
     * Sets the delegate that will process the actions triggered by this panel’s buttons.
     *
