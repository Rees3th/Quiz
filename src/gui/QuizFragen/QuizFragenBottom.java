...
/** Diese Klasse stellt die untere Leiste im QuizFragenPanel dar.
 * Sie enthält Buttons zum Löschen, Speichern und Erstellen neuer Fragen.
 * Die Klasse implementiert ein Delegate-Pattern, um Aktionen an das übergeordnete Panel zu delegieren.
 */
...
public class QuizFragenBottom extends JPanel {
	...
	/** Konstruktor der Klasse, der das Layout und die Buttons initialisiert.
	 * Die Buttons sind mit ActionListenern versehen, die Methoden im Delegate aufrufen.
	 */
	...
	public QuizFragenBottom() {
		...
		speichernButton.addActionListener(e -> {
		    if (delegate != null) delegate.onSaveQuestion();
		});
		deleteButton.addActionListener(e -> {
		    if (delegate != null) delegate.onDeleteQuestion();
		});
