 ...
 * It contains:
 * <ul>
 *     <li>{@link QuizThemeLeft} - left side input form for theme title and description</li>
 *     <li>{@link QuizThemeRight} - right side list displaying all existing themes</li>
 *     <li>{@link QuizThemeBottom} - bottom action bar with "New", "Save", "Delete" buttons</li>
 * </ul>
 * Implements {@link QuizThemeDelegate} to handle actions triggered by the bottom panel.
 * </p>
 * 
 * <p>
 * This panel connects to the {@link QuizDataManager} to load, save, and delete quiz themes.
 * It can also notify a connected {@link QuizQuestionPanel} to refresh its theme data.
 * </p>
 * 
...
public class QuizThemePanel extends JPanel implements QuizThemeDelegate {
    ...
    /** Optional reference to the Quiz Questions panel for theme list synchronization. */
    ...
    /**
     * Initializes the UI structure by creating and adding
     * the left, right, and bottom panels, and setting delegate links.
     */
    private void initUI() {
        quizThemenLeft = new QuizThemeLeft();
        quizThemenRight = new QuizThemeRight(dm.getAllThemen());
     ...
     * <p>
     * If deletion is successful, the themes list is reloaded and the left form is cleared.
     * </p>
     */
    @Override
    public void onDeleteTheme() {
        ...
        int result = JOptionPane.showConfirmDialog(
            ...
            ThemeValidator.MSG_DELETE_CONFIRM_TITLE,
        ...
        if (result == JOptionPane.YES_OPTION) {
            ...
            if (error != null) {
                JOptionPane.showMessageDialog(
                        this,
                        ThemeValidator.MSG_DELETE_ERROR_PREFIX + error,
                        "Fehler",
    ...
    /**
     * {@inheritDoc}
     * Saves a new or edited theme after validation.
     * <p>
     * If a theme is selected in the list, it will be updated.
     * Otherwise, a new theme is created.
     * Displays success or error messages in the bottom panel.
     * </p>
     */
    @Override
    public void onSaveTheme() {
        ...
        // Validate user input
        String validationError = ThemeValidator.validate(titel, info, dm.getAllThemen(), selected);
    ...
    /**
     * {@inheritDoc}
     * Clears the current theme selection and resets the input fields,
    ...
    /**
     * Reloads the theme list in the right panel and, if connected,
     * also triggers a reload of themes in the associated questions panel.
     */
