...
/**
 * {@code QuizThemeRight} is the right-hand panel in the Quiz Theme Management view.
 * <p>
 * It displays a list of available quiz themes and allows the user to select a theme.
 * The selected theme's details are passed to the left panel ({@link QuizThemeLeft})
...
public class QuizThemeRight extends JPanel {
     ...
     * <p>
     * Sets {@link BoxLayout} orientation, border spacing, and preferred/maximum sizes.
     * </p>
     */
    ...
    /**
     * Initializes the {@link ThemaPanel} and sets up a listener to update
     * the linked left panel when the user selects a theme.
     *
     ...
     * <p>
     * This connection allows the left panel to refresh its content when
