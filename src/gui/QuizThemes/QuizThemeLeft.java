 ...
 * <p>
 * It contains input fields for entering or editing the title and description of
 * a quiz theme. The layout and UI elements are built via
 * {@link QuizThemenLeftLayout}.
 * </p>
 * 
 * <p>
 * This panel is typically paired with {@link QuizThemeRight} to form a
 * two-column layout for theme selection and editing.
 * </p>
 * 
...
public class QuizThemeLeft extends JPanel {
	 ...
	 *
	 * @param thema The {@link Theme} whose data should be displayed; if
	 *              {@code null}, the fields will be cleared.
	 */
